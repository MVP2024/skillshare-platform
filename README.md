...
* **Суперпользователь (Администратор)**:
    ...
    * Может **редактировать и удалять свой собственный профиль** через API. Для управления другими пользователями
      рекомендуется использовать Django Admin.
    * Может **просматривать список всех платежей**.

* **Модератор**:
    * **Просмотр всех курсов и уроков**.
    * **Редактирование и удаление всех курсов и уроков**.
