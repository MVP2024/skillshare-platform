...
- Получить детали пользователя (включая платежи): GET /api/users/{id}/
...
- Получить детали курса (включая уроки и их количество): GET /api/courses/{id}/

# Уроки

- Получить список уроков: GET /api/lessons/
- Получить детали урока: GET /api/lessons/{id}/
